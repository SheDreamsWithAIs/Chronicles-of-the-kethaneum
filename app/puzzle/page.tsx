...
export default function PuzzleScreen() {
  ...
  useEffect(() => {
    console.log('[puzzle.page] useEffect triggered - grid.length:', state.grid?.length,
      'isReady:', isReady, 'selectedGenre:', state.selectedGenre, 'currentGenre:', state.currentGenre);
